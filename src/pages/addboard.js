      ...
      <div>
        <div>
          <div className="flex flex-col items-center justify-center">
            <div className="bg-gray-100 border border-blue-500 rounded-xl mb-10">
                {!showInputs && (
                  <button
                ...
                {showInputs && (
                  <div className="mx-3 my-3">
                    ...
                    <div className="flex my-5">
                      ...
                      <button
                        className="w-full p-2 font-mono text-center text-gray-100 bg-blue-500 rounded-md hover:bg-blue-600 border border-lime-700"
                        onClick={handleAdd}
                      >
                        Add
                      </button>
          ...
          {items.length > 0 && (
            <ul className="grid grid-cols-3 gap-5 mx-10">
              {items.map((item, index) => (
                <li key={index}
                  className="my-2 p-5 bg-gray-400 border border-blue-500 rounded-xl"
                >
