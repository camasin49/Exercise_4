        ...
        <div className="w-full min-h-screen flex justify-center items-center bg-gray-900">
            <div>
               ...
               to-transparent-top-[50%] -left-[50%] animate-spin-slow origin-bottom-right"></div>
                <div className="absolute w-[380px] h-[420px] bg-gradient-to-r from-violet-500 via-yellow-500
               to-transparent-top-[50%] -left-[50%] animate-spin-delay origin-bottom-right"> </div>
                <div className="absolute inset-1 bg-gray-800 rounded-lg z-10 p-5"> 
                    ...
                    <button type="submit" 
                        className="py-3 mt-10 font-mono text-gray-100 bg-blue-500 w-full 
                        rounded hover:bg-blue-600 hover-scale-105 duration-300">Register</button>
